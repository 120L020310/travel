# Travel Reverie 7.7.0 · Photo Wall Carousel
...
- 平面地图可放大至 12 级；立体地球可更靠近观察，路线坐标柱也已改细。
- 点击路线地点可让当前平面地图或立体地球对焦；点击地图坐标会打开左下角地点卡，并定位高亮对应路线地点。
- 地图左下角地点信息卡的地点名称已缩小，避免遮挡地图。
...
- 每个照片框可一次添加多张图片；默认照片与自定义照片会自动轮播，点击照片框或聚焦图片后按 Enter／空格可切换下一张。
...
```text
[Travel Reverie] build 7.6.1-compact-map-card-title loaded
